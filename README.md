...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  flyctl apps create space-rocket-rental-1812
  flyctl apps create space-rocket-rental-1812-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app space-rocket-rental-1812
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app space-rocket-rental-1812-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and
  ...
  ```sh
  fly volumes create data --size 1 --app space-rocket-rental-1812
  fly volumes create data --size 1 --app space-rocket-rental-1812-staging
  ```
